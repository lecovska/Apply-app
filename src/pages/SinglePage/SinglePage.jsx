      ...
      {singleCandidate &&
        <div className="singlepage">
          ...
          <div className="bio">
            ...
            <img className="bio-image" src="https://www.assyst.de/cms/upload/sub/digitalisierung/18-F.jpg" alt=""></img>
            </div>
            <div className="personal-info">
            <p><span>Name:   </span><span>{singleCandidate.name}</span></p>
            <p><span>Date:   </span><span>{moment(singleCandidate.birthday).format("DD.MM.YYYY")}</span></p>
            <p><span>Mail:  </span> <span>{singleCandidate.email}</span></p>
            <p><span>Education: </span><span>{singleCandidate.education}</span></p>
